...
async function generateMarkdownPreview() {
  ...
  try {
    ...
    console.log("Markdown preview generated");
  } catch (error) {
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Aquí puedes conectar también los botones PDF si tienes lógica para ellos
  // document.getElementById('exportThemePDF')?.addEventListener('click', () => { /* lógica PDF */ });
  // document.getElementById('exportLessonPDF')?.addEventListener('click', () => { /* lógica PDF */ });
  
  console.log("Teacher English Planner - All functionality initialized");
});